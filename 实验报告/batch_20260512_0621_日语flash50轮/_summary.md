...
| 指标 | 值 |
|:-----|:----|
| reasoning_tokens 最小值 | 195 |
| reasoning_tokens 最大值 | 4096 |
| reasoning_tokens 平均值 | 1054.6 |
| reasoning_tokens 中位数 | 686.0 |
| 波动倍数（max/min） | 21.0 |
| prompt_tokens 平均值 | 51454.0 |
| completion_tokens 平均值 | 4060.2 |
| total_tokens 平均值 | 55514.2 |
| reasoning 中文占比 | 1 / 50 (2.0%) |
...
| 平均每轮 | 9.0 秒 |
| 总 tokens | 2775710 |
| 平均 token 速度 | 6193.5 tok/s |

## 每轮明细

| # | reasoning_tokens | tool_rounds | duration | tok/s | reasoning_lang | output_lang | reasoning_chars | output_chars | reply 前80字 |
|:-:|:---------------:|:-----------:|:--------:|:-----:|:--------------:|:-----------:|:---------------:|:------------:|:----|
| 1 | 1007 | 0 | 76.0s | 730.6 | ja | ja | 1806 | 5232 | 以下に、DeepSeek-V4シリーズの技術レポートの内容を、技術的詳細を保持しつつ読みやすくまとめました。  ---  ## 1. 概要  DeepSeek- |
| 1 | 4095 | 0 | 76.4s | 726.7 | ja | empty | 6649 | 0 |  |
| 1 | 1255 | 0 | 77.4s | 717.8 | ja | ja | 2285 | 4695 | ## DeepSeek-V4 シリーズの概要  DeepSeek-V4 シリーズは、超長文脈処理の効率性を飛躍的に向上させた次世代大規模言語モデルです。2つのM |
| 1 | 639 | 0 | 77.6s | 715.5 | ja | ja | 1037 | 5703 | 以下に、提供された文書の内容を技術的な詳細を省略せずに、セクションごとに整理して読みやすくまとめました。  ---  # DeepSeek-V4: 超高効率10 |
| 1 | 608 | 0 | 79.4s | 699.5 | ja | ja | 986 | 6072 | 以下は、DeepSeek-V4シリーズに関する技術文書の読みやすい要約です。技術的な詳細は可能な限り保持し、構造化して整理しました。  ---  ## Deep |
| 4 | 835 | 0 | 117.7s | 471.9 | ja | ja | 1515 | 5335 | # DeepSeek-V4: 100万トークンコンテキストを効率的に処理する次世代LLM  ## 1. 概要  DeepSeek-AIは、次世代の大規模言語モデ |
| 2 | 341 | 0 | 120.4s | 461.3 | ja | ja | 597 | 6149 | # DeepSeek-V4 シリーズ：技術レポート概要  ## 1. 概要  DeepSeek-AI は、**DeepSeek-V4 シリーズのプレビュー版** |
| 5 | 770 | 0 | 121.7s | 456.3 | ja | ja | 1220 | 5390 | # DeepSeek-V4シリーズ 技術概要  ## 1. 概要  DeepSeek-V4シリーズは、超長文脈（100万トークン）を効率的に処理するために設計さ |
| 3 | 1014 | 0 | 124.0s | 447.9 | ja | ja | 1732 | 5007 | # DeepSeek-V4シリーズ 技術概要まとめ  ## モデル概要  DeepSeek-V4シリーズは、ハイブリッドアテンションアーキテクチャ（CSA +  |
| 6 | 985 | 0 | 127.1s | 436.9 | ja | ja | 1730 | 5152 | 以下は、DeepSeek-V4シリーズに関する技術文書の読みやすい要約です。技術的な詳細は省略せず、構造化してまとめています。  ---  # DeepSeek |
| 7 | 954 | 0 | 163.4s | 339.9 | ja | ja | 1508 | 5272 | はい。ご提供いただいたDeepSeek-V4シリーズの論文（プレビュー版）の内容を、技術的な詳細を省略せずに、読みやすく構造化してまとめました。  ---  # |
| 8 | 401 | 0 | 164.8s | 337.0 | ja | ja | 671 | 5926 | 以下に、DeepSeek-V4シリーズの技術文書を読みやすく、しかし技術的詳細を保持した形でまとめました。  ---  ## DeepSeek-V4シリーズ：超 |
| 9 | 945 | 0 | 167.9s | 330.8 | ja | ja | 1834 | 5347 | 以下、DeepSeek-V4シリーズの技術レポートを読みやすく整理しました。技術的な詳細は省略せず、主要なポイントを簡潔にまとめています。  ---  ## D |
| 11 | 674 | 0 | 169.6s | 327.5 | ja | ja | 1141 | 6123 | 以下に、DeepSeek-V4シリーズの技術文書を、技術的詳細を保持しつつ読みやすく構造化してまとめました。重要な数値やアーキテクチャの詳細は省略せず、箇条書き |
| 10 | 2162 | 0 | 174.3s | 318.7 | ja | ja | 3681 | 3295 | 以下は、DeepSeek-V4シリーズに関する技術論文の内容を、重要な詳細を保持しながら読みやすく構造化してまとめたものです。  ---  ## DeepSee |
| 12 | 505 | 0 | 201.3s | 272.9 | ja | ja | 921 | 5011 | はい、承知しました。以下に、提供されたDeepSeek-V4の技術レポートを元に、技術的な詳細を保持しつつ読みやすく構造化してまとめます。  ---  ## D |
| 13 | 512 | 0 | 205.3s | 269.0 | ja | ja | 842 | 5254 | 以下は、DeepSeek-V4シリーズの技術レポートを、技術的な詳細を維持しつつ整理・要約したものです。元の情報を保持しつつ、構造的で読みやすくしています。   |
| 14 | 2774 | 0 | 213.9s | 259.6 | ja | ja | 4907 | 2329 | 以下は、DeepSeek-V4シリーズのテクニカルレポートの内容を、技術的詳細を保持しつつ読みやすくまとめたものです。特に重要な数値や仕組みは省略せずに整理して |
| 15 | 603 | 0 | 217.8s | 254.7 | ja | ja | 1131 | 5852 | 以下は、ご提供いただいたDeepSeek-V4シリーズの技術レポート「DeepSeek-V4: Towards Highly Efficient Million |
| 16 | 1182 | 0 | 222.4s | 249.8 | ja | ja | 2170 | 4719 | 以下に、DeepSeek-V4シリーズに関する技術文書の内容を、技術的詳細を省略せずに読みやすくまとめました。各セクションの要点を整理し、重要な数値や手法はその |
| 18 | 871 | 0 | 247.5s | 224.4 | ja | ja | 1492 | 5180 | # DeepSeek-V4 シリーズ：100万トークンコンテキストを実現する高効率MoEモデル  ## 概要  DeepSeek-AIは、次世代大規模言語モデル |
| 17 | 461 | 0 | 248.2s | 223.8 | ja | ja | 782 | 5925 | 以下に、DeepSeek-V4シリーズの技術レポートを日本語で読みやすくまとめました。技術的な詳細は可能な限り保持していますが、冗長な表現は整理しています。数値 |
| 19 | 636 | 0 | 258.9s | 214.5 | ja | ja | 1101 | 5351 | # DeepSeek-V4 シリーズ：技術詳細を保持した読みやすい要約  ## 1. 概要と背景  DeepSeek-V4シリーズは、**超長コンテキスト（10 |
| 20 | 832 | 0 | 262.1s | 211.9 | ja | ja | 1484 | 5500 | 以下に、DeepSeek-V4シリーズに関する技術文書の内容を、技術的詳細を省略せずに読みやすくまとめました。  ---  # DeepSeek-V4 シリーズ |
| 21 | 673 | 0 | 266.9s | 208.2 | ja | ja | 1105 | 5724 | 以下に、DeepSeek-V4の論文内容を読みやすく、かつ技術的な詳細を保持した形でまとめます。  ---  ## DeepSeek-V4 シリーズ：高効率な1 |
| 23 | 492 | 0 | 293.0s | 189.6 | ja | ja | 865 | 5891 | 以下に、DeepSeek-V4シリーズの技術文書を読みやすく、かつ技術的詳細を保持した形でまとめました。  # DeepSeek-V4 シリーズ 概要  ##  |
| 22 | 956 | 0 | 295.1s | 188.2 | ja | ja | 2027 | 5166 | 以下は、DeepSeek-V4シリーズの技術レポートの内容を、技術的な詳細を保持しつつ読みやすくまとめたものです。  ---  ## 1. 概要  DeepSe |
| 24 | 418 | 0 | 300.9s | 184.6 | ja | ja | 692 | 6039 | 以下に、DeepSeek-V4シリーズに関する技術論文の内容を、読みやすく整理してまとめました。技術的な詳細は省略せず、重要なポイントを網羅しています。  -- |
| 25 | 4095 | 0 | 305.1s | 182.1 | ja | empty | 6875 | 0 |  |
| 26 | 609 | 0 | 312.8s | 177.6 | ja | ja | 1095 | 5915 | ## DeepSeek-V4 シリーズ プレビュー版 技術レポート まとめ  ### 1. 概要  DeepSeek-V4 シリーズは、超長コンテキスト（最大1 |
| 27 | 448 | 0 | 333.9s | 165.5 | ja | ja | 761 | 5363 | # DeepSeek-V4 シリーズの概要  DeepSeek-V4シリーズは、DeepSeek-AIによって発表されたプレビュー版の大規模言語モデル群です。2 |
| 30 | 4096 | 0 | 337.7s | 164.5 | ja | empty | 6825 | 0 |  |
| 28 | 1171 | 0 | 337.7s | 164.5 | ja | ja | 1876 | 4828 | # DeepSeek-V4 シリーズ 技術レポート要約  ## 1. 概要  DeepSeek-V4シリーズは、超長文脈処理における効率性の壁を打破するために開 |
| 29 | 529 | 0 | 344.9s | 161.1 | ja | ja | 883 | 6161 | 以下に、与えられた文書の内容を技術的詳細を省略せずに、読みやすく構造化してまとめました。各セクションの主要なポイントを箇条書きや短い説明で整理しています。  - |
| 31 | 784 | 0 | 355.9s | 156.1 | ja | ja | 1328 | 5484 | # DeepSeek-V4 シリーズ技術概要  ## 1. 概要  DeepSeek-V4シリーズは、Mixture-of-Experts（MoE）アーキテクチ |
| 32 | 611 | 0 | 377.9s | 147.0 | ja | ja | 999 | 5596 | 以下に、DeepSeek-V4シリーズの技術レポートを、技術的な詳細を保持しつつ読みやすくまとめました。主要なセクションごとに整理し、重要なポイントを箇条書きや |
| 33 | 936 | 0 | 379.5s | 146.4 | ja | ja | 1672 | 5193 | # DeepSeek-V4 シリーズ 技術レポート 要約  ## 概要  DeepSeek-V4シリーズは、次世代の超長コンテキスト処理向け大規模言語モデルです |
| 34 | 643 | 0 | 382.9s | 145.1 | ja | ja | 1066 | 5567 | 以下は、ご提供いただいたDeepSeek-V4シリーズの技術報告書（Abstract、1〜4章）について、技術的詳細を保持しつつ読みやすく構造化したまとめです。 |
| 35 | 1656 | 0 | 390.8s | 142.1 | ja | ja | 2659 | 4016 | 以下に、DeepSeek-V4に関する技術文書の内容を、技術的な詳細を保持しつつ読みやすく構造化してまとめます。各セクションは元の文書の流れに沿い、重要な数値や |
| 36 | 435 | 0 | 400.1s | 138.8 | ja | ja | 733 | 5781 | # DeepSeek-V4 シリーズ：技術概要  DeepSeek-AIが発表したDeepSeek-V4シリーズは、**100万トークンのコンテキスト長**を効 |
| 38 | 506 | 0 | 417.1s | 132.2 | ja | ja | 852 | 5195 | # DeepSeek-V4 シリーズ：技術レポートの要約  ## 概要  DeepSeek-AI は、DeepSeek-V4 シリーズのプレビュー版を公開しまし |
| 37 | 195 | 0 | 421.9s | 131.7 | ja | ja | 316 | 6611 | # DeepSeek-V4シリーズ技術レポートの概要  ## 1. 概要  DeepSeek-V4シリーズは、次世代の大規模言語モデルであり、超長文コンテキスト |
| 39 | 3628 | 0 | 424.4s | 130.9 | ja | ja | 5675 | 851 | # DeepSeek-V4シリーズ 技術レポート概要  ## 1. 概要  DeepSeek-AIは、DeepSeek-V4シリーズのプレビュー版を公開した。本 |
| 40 | 614 | 0 | 435.5s | 127.6 | ja | ja | 1112 | 6165 | 以下に、DeepSeek-V4 シリーズの技術レポートの内容を、技術的詳細を保持しつつ読みやすく構造化してまとめます。原文は非常に長大ですが、主要な章（1. I |
| 41 | 391 | 0 | 441.4s | 125.8 | ja | ja | 713 | 6146 | 以下、DeepSeek-V4シリーズの技術報告を読みやすく整理したものです。技術的な詳細はすべて保持し、省略していません。  ---  ## DeepSeek- |
| 42 | 1338 | 0 | 461.7s | 120.3 | ja | ja | 2434 | 4649 | 以下、DeepSeek-V4シリーズのテクニカルレポートの内容を、技術的詳細を省かずに読みやすくまとめました。  ## 1. 全体概要 DeepSeek-V4シ |
| 43 | 401 | 0 | 468.6s | 118.5 | zh | ja | 722 | 6180 | はい、承知しました。以下が、提供されたDeepSeek-V4の技術レポートを読みやすく、かつ技術的な詳細を省略せずにまとめたものです。  ---  ## **D |
| 44 | 1128 | 0 | 468.7s | 118.5 | ja | ja | 2050 | 4971 | # DeepSeek-V4 シリーズ 技術概要  ## 1. 概要  DeepSeek-V4シリーズは、Mixture-of-Experts (MoE) アーキ |
| 45 | 216 | 0 | 476.9s | 116.5 | ja | ja | 376 | 6194 | # DeepSeek-V4シリーズ：高効率な100万トークンコンテキスト処理を実現するMoE言語モデル  ## 概要  DeepSeek-V4シリーズは、Dee |
| 46 | 698 | 0 | 481.3s | 115.4 | ja | ja | 1254 | 5910 | 以下に、DeepSeek-V4シリーズの技術論文の内容を、技術的な詳細を省略せずに読みやすくまとめました。  ---  # DeepSeek-V4シリーズ：高効 |
