...
| 指标 | 值 |
|:-----|:----|
| reasoning_tokens 最小值 | 99 |
| reasoning_tokens 最大值 | 1327 |
| reasoning_tokens 平均值 | 471.3 |
| reasoning_tokens 中位数 | 446.5 |
| 波动倍数（max/min） | 13.4 |
| prompt_tokens 平均值 | 51472.0 |
| completion_tokens 平均值 | 3120.5 |
| total_tokens 平均值 | 54592.5 |
| reasoning 中文占比 | 0 / 50 (0.0%) |
| reasoning 英文占比 | 4 / 50 (8.0%) |
| 工具调用轮数 平均值 | 0.0 |
...
| 平均每轮 | 7.1 秒 |
| 总 tokens | 2729625 |
| 平均 token 速度 | 7674.3 tok/s |

## 每轮明细

| # | reasoning_tokens | tool_rounds | duration | tok/s | reasoning_lang | output_lang | reasoning_chars | output_chars | reply 前80字 |
|:-:|:---------------:|:-----------:|:--------:|:-----:|:--------------:|:-----------:|:---------------:|:------------:|:----|
| 1 | 417 | 0 | 62.6s | 860.4 | fa | fa | 1036 | 5346 | # خلاصه DeepSeek-V4: معماری، آموزش و ارزیابی  ## نمای کلی  DeepSeek-V4 دو مدل Mo |
| 1 | 586 | 0 | 65.3s | 829.2 | fa | fa | 1460 | 5341 | ## خلاصه DeepSeek-V4: گامی به سوی هوش زمینه‌ای با کارایی فوق‌بالا در میلیون‌ها ت |
| 1 | 313 | 0 | 71.6s | 765.4 | fa | fa | 767 | 8192 | # خلاصه مقاله DeepSeek-V4  ## معرفی کلی  DeepSeek-V4 نسخه پیش‌نمایش از سری مدل‌ه |
| 1 | 234 | 0 | 72.8s | 757.1 | fa | fa | 640 | 9144 | # خلاصه DeepSeek-V4  ## معرفی کلی  DeepSeek-V4 سری جدیدی از مدل‌های زبانی بزرگ ب |
| 1 | 837 | 0 | 77.8s | 710.8 | fa | fa | 2165 | 7261 | ## خلاصه DeepSeek-V4  **معرفی کلی**   DeepSeek-V4 یک سری مدل زبانی بزرگ از نوع M |
| 5 | 211 | 0 | 88.7s | 595.9 | fa | fa | 553 | 3162 | # خلاصه DeepSeek-V4  ## معرفی کلی DeepSeek-V4 سری جدیدی از مدل‌های زبانی بزرگ با |
| 3 | 437 | 0 | 97.6s | 556.1 | fa | fa | 1009 | 5717 | # خلاصه DeepSeek-V4: نسل جدید مدل‌های زبانی با پشتیبانی از یک میلیون توکن  ## نم |
| 4 | 554 | 0 | 97.9s | 549.3 | fa | fa | 1232 | 4581 | # خلاصه DeepSeek-V4  ## معرفی کلی  DeepSeek-V4 دو مدل زبانی از نوع Mixture-of-Ex |
| 2 | 179 | 0 | 106.3s | 520.2 | fa | fa | 410 | 8977 | # خلاصه DeepSeek-V4  ## معرفی کلی  DeepSeek-V4 یک سری مدل زبان بزرگ از نوع Mixtu |
| 6 | 556 | 0 | 109.7s | 496.4 | fa | fa | 1358 | 6215 | ## خلاصه DeepSeek-V4  **معرفی کلی:** DeepSeek-V4 مجموعه‌ای از مدل‌های زبانی بزرگ |
| 9 | 99 | 0 | 125.0s | 432.4 | fa | fa | 246 | 6301 | # خلاصه DeepSeek-V4: مدل‌های زبانی با قابلیت پردازش یک میلیون توکن  ## معرفی کلی |
| 7 | 654 | 0 | 129.2s | 427.0 | fa | fa | 1715 | 7370 | # خلاصه مقاله DeepSeek-V4  ## معرفی کلی DeepSeek-V4 دو مدل Mixture-of-Experts (M |
| 8 | 496 | 0 | 134.7s | 405.9 | fa | en | 1436 | 7813 | # خلاصه DeepSeek-V4  ## مدل‌ها و معماری  **DeepSeek-V4** در دو نسخه معرفی شده اس |
| 10 | 368 | 0 | 138.2s | 393.3 | fa | fa | 862 | 5945 | # خلاصه DeepSeek-V4: معماری کارآمد برای زمینه‌های میلیون‌توکنی  ## نمای کلی  Dee |
| 11 | 1227 | 0 | 155.0s | 358.6 | fa | fa | 2905 | 7183 | در این مقاله، نسخه پیش‌نمایش از سری مدل‌های DeepSeek-V4 معرفی شده است که شامل دو |
| 12 | 277 | 0 | 164.5s | 337.7 | fa | fa | 681 | 9802 | # خلاصه مقاله DeepSeek-V4  ## معرفی کلی  DeepSeek-V4 شامل دو مدل **Mixture-of-Ex |
| 15 | 527 | 0 | 165.3s | 327.6 | fa | fa | 1223 | 5457 | # خلاصه DeepSeek-V4: دستیابی به هوشمندی با بافت میلیون‌تایی با کارایی بالا  ## ن |
| 13 | 333 | 0 | 171.2s | 322.2 | fa | fa | 774 | 8725 | # خلاصه فنی DeepSeek-V4  ## معرفی کلی  DeepSeek-V4 مجموعه‌ای از مدل‌های زبانی بز |
| 14 | 508 | 0 | 176.4s | 315.0 | fa | fa | 1132 | 9691 | ## خلاصه مقاله DeepSeek-V4  ### مرور کلی DeepSeek-V4 یک سری مدل‌های زبانی بزرگ ب |
| 17 | 354 | 0 | 189.0s | 283.7 | fa | fa | 850 | 4970 | # خلاصه DeepSeek-V4: معماری میلیون-توکنی کارآمد  ## مدل‌های معرفی‌شده  **DeepSee |
| 16 | 468 | 0 | 191.9s | 285.8 | fa | fa | 1153 | 7205 | # خلاصه DeepSeek-V4  ## معرفی کلی  DeepSeek-V4 دو مدل MoE است: - **DeepSeek-V4-P |
| 20 | 371 | 0 | 205.4s | 264.2 | fa | fa | 928 | 6219 | # خلاصه DeepSeek-V4  ## معرفی مقاله نسخه پیش‎نمایش سری **DeepSeek-V4** را معرفی  |
| 18 | 962 | 0 | 208.8s | 264.3 | fa | fa | 2437 | 7312 | ## خلاصه مقاله DeepSeek-V4: مدل‌های زبانی با کارایی بالا برای بافت میلیون‌توکنی  |
| 19 | 720 | 0 | 210.4s | 262.1 | fa | fa | 1826 | 7766 | ## خلاصه مقاله DeepSeek-V4  مقاله **DeepSeek-V4** نسخه پیش‌نمایش یک خانواده از م |
| 22 | 437 | 0 | 222.1s | 243.9 | fa | fa | 1139 | 5588 | # خلاصه DeepSeek-V4  ## معرفی کلی  DeepSeek-V4 سری جدیدی از مدل‌های زبانی بزرگ ب |
| 21 | 543 | 0 | 223.0s | 244.2 | fa | fa | 1253 | 6014 | # خلاصه مقاله DeepSeek-V4  ## معرفی  DeepSeek-V4 یک نسخه پیشنمایش از سری مدل‌های |
| 23 | 403 | 0 | 244.6s | 225.0 | fa | fa | 913 | 7555 | # خلاصه DeepSeek-V4: معماری کارآمد برای زمینه‌های میلیون‌توکنی  ## معرفی کلی  ** |
| 25 | 529 | 0 | 248.1s | 220.8 | fa | fa | 1265 | 7122 | # خلاصه DeepSeek-V4  ## معرفی کلی  DeepSeek-V4 سری جدیدی از مدل‌های زبانی بزرگ ب |
| 27 | 137 | 0 | 250.7s | 215.6 | fa | fa | 338 | 6139 | # خلاصه DeepSeek-V4  ## معرفی کلی DeepSeek-V4 دو مدل Mixture-of-Experts (MoE) ار |
| 24 | 631 | 0 | 254.2s | 218.6 | fa | en | 1625 | 9676 | # خلاصه مقاله DeepSeek-V4  ## معرفی کلی  این مقاله نسخه پیش‌نمایش از سری مدل‌های |
| 26 | 555 | 0 | 254.8s | 213.7 | fa | fa | 1272 | 5809 | # خلاصه مقاله DeepSeek-V4  ## معرفی کلی  DeepSeek-V4 نسخه پیشنمایش از نسل جدید م |
| 28 | 185 | 0 | 263.4s | 202.2 | en | fa | 911 | 4146 | ## خلاصه DeepSeek-V4: به سوی پردازش کارآمد میلیون‌ها توکن  **چکیده:** DeepSeek-V |
| 30 | 648 | 0 | 282.0s | 192.1 | fa | fa | 1631 | 5478 | ## خلاصه DeepSeek-V4: معماری جدید برای بازدهی در زمینه‌های میلیون‌تایی  DeepSeek |
| 31 | 341 | 0 | 286.6s | 189.3 | fa | fa | 825 | 6467 | # خلاصه DeepSeek-V4  ## نمای کلی  DeepSeek-V4 یک سری مدل‌های زبان بزرگ (LLM) از  |
| 32 | 1158 | 0 | 295.2s | 186.8 | fa | fa | 2807 | 6286 | ## خلاصه مقاله DeepSeek-V4  این مقاله به معرفی نسخه پیش‌نمایش **سری DeepSeek-V4* |
| 29 | 494 | 0 | 296.7s | 187.3 | en | fa | 2130 | 8870 | # خلاصهٔ فنی DeepSeek-V4  ## نمای کلی  DeepSeek-V4 دو مدل MoE (Mixture-of-Expert |
| 33 | 223 | 0 | 298.3s | 183.3 | fa | fa | 533 | 7466 | ## خلاصه DeepSeek-V4  ### معرفی کلی  دیپ‌سیک نسخه پیش‌نمایش سری DeepSeek-V4 را م |
| 34 | 192 | 0 | 309.3s | 174.1 | fa | fa | 466 | 5303 | # خلاصه مقاله DeepSeek-V4  ## معرفی کلی  DeepSeek-V4 سری جدیدی از مدل‌های زبانی  |
| 38 | 256 | 0 | 318.8s | 167.1 | en | fa | 1146 | 3910 | ## خلاصه محتوای فنی DeepSeek-V4  **معرفی کلی**   مدل‌های DeepSeek-V4 شامل دو نسخ |
| 35 | 587 | 0 | 325.1s | 168.5 | fa | fa | 1451 | 7064 | ## خلاصه DeepSeek-V4  ### معرفی کلی  این مقاله نسخه پیش‌نمایش سری DeepSeek-V4 را |
| 39 | 456 | 0 | 330.0s | 161.7 | fa | fa | 1093 | 3694 | # خلاصه DeepSeek-V4  ## معرفی کلی DeepSeek-V4 نسخه پیشنمایش از سری جدید مدل‌های  |
| 36 | 516 | 0 | 337.4s | 164.7 | fa | fa | 1334 | 8800 | # خلاصهٔ DeepSeek-V4: دستیابی به هوش زمینه‌ای با یک میلیون توکن  **معرفی و مدل‌ه |
| 37 | 591 | 0 | 341.7s | 162.6 | fa | fa | 1407 | 8425 | # خلاصه DeepSeek-V4  ## معرفی کلی  DeepSeek-V4 دو مدل MoE (Mixture-of-Experts) ق |
| 41 | 154 | 0 | 353.1s | 152.9 | fa | fa | 431 | 5999 | # خلاصه DeepSeek-V4  ## معرفی کلی  DeepSeek-V4 سری جدیدی از مدل‌های زبانی بزرگ ب |
| 40 | 250 | 0 | 358.5s | 155.0 | fa | fa | 641 | 9397 | # خلاصه DeepSeek-V4  ## معرفی کلی  DeepSeek-V4 یک سری مدل زبان بزرگ جدید از Deep |
| 43 | 303 | 0 | 368.5s | 147.2 | fa | fa | 743 | 6065 | # خلاصه مقاله DeepSeek-V4  ## معرفی کلی  DeepSeek-V4 مجموعه‌ای از مدل‌های زبانی  |
| 42 | 128 | 0 | 370.3s | 150.0 | en | fa | 635 | 9634 | # خلاصه مقاله DeepSeek-V4: به سوی هوش زمینه میلیون-توکن با کارایی بالا  این مقال |
| 44 | 522 | 0 | 376.4s | 145.2 | fa | fa | 1316 | 6668 | # خلاصه DeepSeek-V4  ## نمای کلی  DeepSeek-V4 دو مدل **Mixture-of-Experts (MoE)* |
| 46 | 312 | 0 | 377.3s | 140.9 | fa | fa | 777 | 3403 | # خلاصه مقاله DeepSeek-V4  ## معرفی کلی  مقاله **DeepSeek-V4** مجموعه‌ای از مدل‌ |
| 45 | 1327 | 0 | 390.5s | 141.7 | fa | fa | 3168 | 6326 | ## خلاصه مقاله DeepSeek-V4: دستاوردهای جدید در کارایی بافت‌های میلیون‌تایی  ###  |
